...
public class TextViewBindingAdapter {
    ...
    public static void loadDrawable(final TextView textView, String url, Drawable placeHolder, final int position, Transformation<Bitmap>[] transformations) {
    ...
    public static void loadDrawable(final TextView textView, String url, Drawable placeHolder, final int position) {
        loadDrawable(textView, url, placeHolder, position, null);
    }


    @BindingAdapter({"drawableUrl", "position"})
    public static void loadDrawable(final TextView textView, String url, final int position) {
    ...
    public static void setDrawableTop(TextView textView, Drawable drawable, int size) {
        setDrawableTop(textView, drawable, size, null);
    }

    @BindingAdapter({"drawableTop", "drawableWidth", "drawableHeight"})
    public static void setDrawableTop(TextView textView, Drawable drawable, int width, int height) {
        setTextDrawable(textView, drawable, Gravity.TOP, width, height);
    }

    @BindingAdapter({"drawableTop", "drawableSize", "drawableTint"})
    public static void setDrawableTop(TextView textView, Drawable drawable, int size, ColorStateList colorStateList) {
    ...
    public static void setDrawableTop(TextView textView, int resId, int size) {
    ...
    public static void setDrawableLeft(TextView textView, Drawable drawable, int size) {
        setTextDrawable(textView, drawable, Gravity.LEFT, size, size);
    }

    @BindingAdapter({"drawableLeft", "drawableWidth", "drawableHeight"})
    public static void setDrawableLeft(TextView textView, Drawable drawable, int width, int height) {
        setTextDrawable(textView, drawable, Gravity.LEFT, width, height);
    }

    @BindingAdapter({"drawableLeftResId", "drawableSize"})
    public static void setDrawableLeft(TextView textView, int resId, int size) {
        if (resId > 0) {
    ...
    public static void setDrawableRight(TextView textView, Drawable drawable, int size) {
        setTextDrawable(textView, drawable, Gravity.RIGHT, size, size);
    }

    @BindingAdapter({"drawableRightResId", "drawableSize"})
    public static void setDrawableRight(TextView textView, int resId, int size) {
    ...
    public static void setDrawableBottom(TextView textView, Drawable drawable, int size) {
        setTextDrawable(textView, drawable, Gravity.BOTTOM, size, size);
    }

    @BindingAdapter({"drawableBottomResId", "drawableSize"})
    public static void setDrawableBottom(TextView textView, int resId, int size) {
    ...
    private static void setTextDrawable(TextView textView, Drawable drawable, int gravity, int drawableWidth, int drawableHeight) {
        Drawable resizedDrawable = drawable;
        if (resizedDrawable != null && drawableWidth >= 0 && drawableHeight >= 0) {
